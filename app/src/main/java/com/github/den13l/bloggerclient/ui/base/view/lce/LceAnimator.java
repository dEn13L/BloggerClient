...
class LceAnimator {
  ...
  static void showLoading(@NonNull View loadingView, @NonNull View contentView,
  ...
  static void showErrorView(@NonNull final View loadingView, @NonNull final View contentView,
  ...
  static void showContent(@NonNull final View loadingView, @NonNull final View contentView,
